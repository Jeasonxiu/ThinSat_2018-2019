...
if strcmp(button_ans,'Yes') == 1
    ...
    if get(handles.checkbox2,'Value') == 1
        catalog(2,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/noaa.txt','noaa.txt');
    ...
    if get(handles.checkbox3,'Value') == 1
        catalog(3,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/goes.txt','goes.txt');
    ...
    if get(handles.checkbox4,'Value') == 1
        catalog(4,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/resource.txt','resource.txt');
    ...
    if get(handles.checkbox5,'Value') == 1
        catalog(5,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/sarsat.txt','sarsat.txt');
    ...
    if get(handles.checkbox6,'Value') == 1
        catalog(6,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/dmc.txt','dmc.txt');
    ...
    if get(handles.checkbox7,'Value') == 1
        catalog(7,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/tdrss.txt','tdrss.txt');
    ...
    if get(handles.checkbox8,'Value') == 1
        catalog(8,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/argos.txt','argos.txt');
    ...
    if get(handles.checkbox9,'Value') == 1
        catalog(9,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/geo.txt','geo.txt');
    ...
    if get(handles.checkbox10,'Value') == 1
        catalog(10,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/intelsat.txt','intelsat.txt');
    ...
    if get(handles.checkbox11,'Value') == 1
        catalog(11,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/gorizont.txt','gorizont.txt');
    ...
    if get(handles.checkbox12,'Value') == 1
        catalog(12,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/raduga.txt','raduga.txt');
    ...
    if get(handles.checkbox13,'Value') == 1
        catalog(13,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/molniya.txt','molniya.txt');
    ...
    if get(handles.checkbox14,'Value') == 1
        catalog(14,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/iridium.txt','iridium.txt');
    ...
    if get(handles.checkbox15,'Value') == 1
        catalog(15,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/orbcomm.txt','orbcomm.txt');
    ...
    if get(handles.checkbox16,'Value') == 1
        catalog(16,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/globalstar.txt','globalstar.txt');
    ...
    if get(handles.checkbox17,'Value') == 1
        catalog(17,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/amateur.txt','amateur.txt');
    ...
    if get(handles.checkbox18,'Value') == 1
        catalog(18,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/x-comm.txt','x-comm.txt');
    ...
    if get(handles.checkbox19,'Value') == 1
        catalog(19,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/other-comm.txt','other-comm.txt');
    ...
    if get(handles.checkbox20,'Value') == 1
        catalog(20,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/gps-ops.txt','gps-ops.txt');
    ...
    if get(handles.checkbox21,'Value') == 1
        catalog(21,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/glo-ops.txt','glo-ops.txt');
    ...
    if get(handles.checkbox22,'Value') == 1
        catalog(22,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/galileo.txt','galileo.txt');
    ...
    if get(handles.checkbox23,'Value') == 1
        catalog(23,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/beidou.txt','beidou.txt');
    ...
    if get(handles.checkbox24,'Value') == 1
        catalog(24,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/sbas.txt','sbas.txt');
    ...
    if get(handles.checkbox25,'Value') == 1
        catalog(25,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/nnss.txt','nnss.txt');
    ...
    if get(handles.checkbox26,'Value') == 1
        catalog(26,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/musson.txt','musson.txt');
    ...
    if get(handles.checkbox27,'Value') == 1
        catalog(27,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/science.txt','science.txt');
    ...
    if get(handles.checkbox28,'Value') == 1
        catalog(28,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/geodetic.txt','geodetic.txt');
    ...
    if get(handles.checkbox29,'Value') == 1
        catalog(29,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/engineering.txt','engineering.txt');
    ...
    if get(handles.checkbox30,'Value') == 1
        catalog(30,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/education.txt','education.txt');
    ...
    if get(handles.checkbox31,'Value') == 1
        catalog(31,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/military.txt','military.txt');
    ...
    if get(handles.checkbox32,'Value') == 1
        catalog(32,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/radar.txt','radar.txt');
    ...
    if get(handles.checkbox33,'Value') == 1
        catalog(33,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/cubesat.txt','cubesat.txt');
    ...
    if get(handles.checkbox34,'Value') == 1
        catalog(34,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/other.txt','other.txt');
    ...
    if get(handles.checkbox35,'Value') == 1
        catalog(35,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/tle-new.txt','tle-new.txt');
    ...
    if get(handles.checkbox36,'Value') == 1
        catalog(36,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/stations.txt','stations.txt');
    ...
    if get(handles.checkbox37,'Value') == 1
        catalog(37,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/visual.txt','visual.txt');
    ...
    if get(handles.checkbox38,'Value') == 1
        catalog(38,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/1999-025.txt','1999-025.txt');
    ...
    if get(handles.checkbox39,'Value') == 1
        catalog(39,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/iridium-33-debris.txt','iridium-33-debris.txt');
    ...
    if get(handles.checkbox40,'Value') == 1
        catalog(40,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/cosmos-2251-debris.txt','cosmos-2251-debris.txt');
    ...
    if get(handles.checkbox41,'Value') == 1
        catalog(41,1) = 1;
        urlwrite('https://celestrak.com/NORAD/elements/2012-044.txt','2012-044.txt');
